...
CREATE TRIGGER ACTUALIZAR_HISTORICO_PUNTUACIONES_MOVILIDAD_EMPRESA BEFORE INSERT ON MOVILIDADES_EMPRESAS
FOR EACH ROW
BEGIN
...
IF (PUNTUACIONSOCIO+VALORPUNTUACION>=DEFICIT) THEN
...
CREATE TRIGGER ACTUALIZAR_HISTORICO_PUNTUACIONES_MOVILIDAD_INSTITUCION BEFORE INSERT ON MOVILIDADES_INSTITUCIONES
FOR EACH ROW
BEGIN
DECLARE PUNTUACIONNUEVA INT;
DECLARE SOCIONUEVO INT;
...
INSERT INTO HISTORICO_PUNTUACIONES (FECHA,TIPO_PUNTUACION,SOCIO) VALUES (NOW(),PUNTUACIONNUEVA,NEW.ID_SOCIO);
END;
